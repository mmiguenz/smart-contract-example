...
def get_contract(contract_name):
    """This function will grab de contract addresss from the brownie config if defined,
    otherwise, it will deploy a mock version of that contract and return that mock contract

        Args:
            contract_name (string)
        Returns:
            brownie.network.contract.ProjectContract: The most deployed version of this contract.
    """
